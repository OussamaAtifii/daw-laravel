...
@endsection
@section('contenido')
    <form method="POST" action="{{ route('posts.update', $post) }}" enctype="multipart/form-data" class="w-1/2 mx-auto">
        ...
        <div class="mb-6">
            <label for="publicado" class="block mb-2 text-sm font-medium text-gray-900">
                Publicado</label>
            <input type="checkbox" value="SI" name="publicado" id="publicado" @checked(old('publicado', $post->publicado) == 'SI')>
